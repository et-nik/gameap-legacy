<?php
	...
	require __DIR__ . '/SourceQuery/Exception.class.php';
	require __DIR__ . '/SourceQuery/Buffer.class.php';
	require __DIR__ . '/SourceQuery/Socket.class.php';
	require __DIR__ . '/SourceQuery/Rcon.class.php';
	
	class CI_SourceQuery
	{
		/**
