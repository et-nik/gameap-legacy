...
$lang['server_files_title_index'] 								= 'АдминПанель :: Файлы';
$lang['server_files_header_index'] 								= 'Файлы';

$lang['server_files_data_writed'] 								= 'Данные записаны';
$lang['server_files_upload_successful'] 						= 'Файл <strong>%s</strong> успешно загружен в директорию <strong>%s</strong>';


/* Errors */
$lang['server_files_no_privileges'] 							= 'Нет прав для загрузки файлов и правки конфигурации сервера';
$lang['server_files_ftp_not_set'] 								= 'Не настроен FTP. Обратитесь к администратору';
$lang['server_files_no_cfg_privileges'] 						= 'Нет прав для правки конфигурации сервера';
$lang['server_files_cfg_not_found'] 							= 'Конфигурационный файл с таким ID не найден';
$lang['server_files_content_dir_not_found'] 					= 'Контент директория с таким ID не найден';
$lang['server_files_upload_error'] 								= 'Ошибка загрузки';
